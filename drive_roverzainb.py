...
class RoverState():
    def __init__(self):
        ...
        self.stop_forward = 15 # Threshold to initiate stopping
        ...
        self.min_mapped = 80 #The minimum allowed mapping before return home
        self.start_pos = None # Records starting position for when we return
